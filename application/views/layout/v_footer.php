						...
						<div class="row">
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_about">
									<div class="footer_logo_container">
										<a href="#">
											<div class="footer_logo_text"><span><?= $setting->nama_kampus ?></span></div>
										</a>
									</div>
									<div class="footer_about_text">
										<p>"Future of education and technology"</p>
									</div>
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_contact">
									...
									<div class="footer_contact_info">
										<ul>
											<li>Email: dreamuniversity@gmail.com</li>
											<li>Phone:  <?= $setting->no_telpon ?></li>
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_links">
									<div class="footer_title">Isi Konten</div>
									<div class="footer_links_container">
										<ul>
											...
											<li><a href="<?= base_url('home/dosen') ?>">Dosen</a></li>
											<li><a href="<?= base_url('home/mahasiswa') ?>">Mahasiswa</a></li>
